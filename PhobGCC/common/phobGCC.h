...
//#include "../rp2040/include/PicoProtoboard.h"    // For a protoboard with a Pico/Pico 2 on it, used for developing for the Pico target
//#include "../rp2040/include/Phob2_0.h"           // For PhobGCC Board 2.0 with RP2040/RP2350

// Default to the Phob 2.0 Pico pinout when building the Pico target unless
// a different board header was explicitly included above.
#if !defined(PHOB_BOARD_HEADER_SELECTED)
	#if defined(PICO_RP2040) || defined(PICO_RP2350)
		#include "../rp2040/include/Phob2_0.h"
	#endif
#endif

#if !defined(PHOB_BOARD_HEADER_SELECTED)
	#error "No hardware board header selected. Uncomment the appropriate board include in PhobGCC/common/phobGCC.h."
#endif
...
#ifdef PHOB_PICO_PLATFORM
	.interlaceOffset = 0,
	.interlaceOffsetMin = -150,
	.interlaceOffsetMax = 150,
#endif //PHOB_PICO_PLATFORM
};
